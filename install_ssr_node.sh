...
install_supervisord(){
	...
	wget https://github.com/chinawiz/ss-config/raw/master/supervisord.conf -O /etc/supervisord.conf
	wget https://github.com/chinawiz/ss-config/raw/master/supervisord -O /etc/init.d/supervisord
